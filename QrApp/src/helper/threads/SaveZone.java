...
public class SaveZone extends AsyncTask <String, Void, String> {
	...
	public SaveZone (Activity act, ProgressDialog tempd){
	...
	protected String doInBackground(String... params) {
		...
		Log.d("QrApp", "SaveZone-doInBackground: Enviando zona al servidor");
		String response = "";
		try {
		...
		try {
			...
			Log.d("QrApp", "SaveZone-doInBackground: Decodificando respuesta");
			...
			Log.e("QrApp", "SaveZone-doInBackground: fallo el envio del registo");
	...
	Log.d("QrApp", "SaveZone-doInBackground: "+result.toString());
...
//			pd.dismiss();
		  ...
		  Log.e("QrApp", "SaveZone-doInBackground: Error al guardar la zona: "+ e.getMessage());
//		  pd.dismiss();
	  }
