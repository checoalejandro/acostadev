...
public class SendQualityGroupValue extends AsyncTask <String, Void, String> {
	...
	public SendQualityGroupValue (Activity act, ProgressDialog tempd){
	...
	public SendQualityGroupValue (Activity act, ProgressDialog tempd, boolean pdmessage){
