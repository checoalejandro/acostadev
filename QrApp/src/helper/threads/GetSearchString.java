...
public class GetSearchString extends AsyncTask <String, Void, String> {
	...
	public GetSearchString (Activity act, ProgressDialog tempd){
	...
	public GetSearchString (Activity act, ProgressDialog tempd, boolean close){
...
//				Toast.makeText(this.activity, "No se han encontrado resultados" , Toast.LENGTH_SHORT).show();
	...
	try{
		...
		if(isSuccessfull){
			...
			Intent intent;
			intent = new Intent(activity, BizneListActivity.class);
