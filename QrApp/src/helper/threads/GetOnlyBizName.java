...
public class GetOnlyBizName extends AsyncTask <String, Void, String> {
	...
	public GetOnlyBizName (Activity act, ProgressDialog tempd){
...
//				Toast.makeText(this.activity, "No hay actividad asignada" , Toast.LENGTH_SHORT).show();
	...
	try{
		...
		if(isSuccessfull){
			MainActivity.lastbiz = GetOnlyBizName.act.getBizneInfo();
